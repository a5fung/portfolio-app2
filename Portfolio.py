...
sheet_url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRkn_uS7XLMvSK3pW0f8QIAVgoT0Lj3U_O-3VkMTgW6ATZtYILU30t7Fih5lj28uZcWjk3CzKu2iFat/pub?gid=710960365&single=true&output=csv"

df = pd.DataFrame()
if "PASTE_YOUR" not in sheet_url:
    df = load_data(sheet_url)

if df.empty:
    st.warning("⚠️ No data found. Please upload your CSV file.")
...
try:
    ...
    # Clean YTD Column (Changed from Weekly %)
...
with t1:
    ...
    with cr:
        # Sunburst for Summary (Bucket -> Account)
...
with t3:
    ...
    with c1:
        ...
        # Sunburst: Bucket (Inner) -> Account (Outer)
